...
<body>
    ...
    <script type="text/javascript">
        ...
        // 1、页面加载完成以后，直接发送一个ajax请求，要到分页数据result(这个result是json字符串)
        $(function(){
            // 页面一加载，就显示第一页
            to_page(1);
        });
        ...
        function to_page(pn){
            $.ajax({
                ...
                data:"pn="+pn,
                type:"GET",
                // 通过ajax请求，获取到result结果集，这是一个json格式的字符串，里面包含了Controller层传来的PageInfo信息。
        ...
        function build_emps_table(result) {
            //在每次加载页面的时候，清空table表格原有的数据
            $("#emps_table tbody").empty();
            var emps = result.extend.pageInfo.list;  // 这是json字符串里的员工表的内容
            // foreach循环添加
        ...
        function build_page_nav(result){
            ...
            // 如果上一页和首页都没有元素了，就给它俩添加disable属性
            ...
            // 如果下一页和末页都没有元素了，就给它俩添加disable属性
